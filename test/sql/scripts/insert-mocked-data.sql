...
INSERT INTO skills.user_skill (skill_id, user_id, skill_value, interested, comments)
VALUES  (1, 'asldkan21ansdkasnd', 4, true, ''),
        (4, 'asldkan21ansdkasnd', 3, true, ''),
        (1, 'asldka12312sdkasnd', 3, true, ''),
        (2, 'asldkan21ansdkasnd', 2, false, ''),
        (2, 'asldka12311sdkasnd', 2, false, ''),
        (1, 'asldka12311sdkasnd', 4, false, ''),
        (3, 'asldka12345sdkasnd', 3, false, ''),
        (4, 'asldka12345sdkasnd', 2, false, ''),
        (1, 'asldka12345sdkasnd', 1, false, ''),
        (2, 'asldka12345sdkasnd', 1, false, ''),
        (2, 'asldka12389sdkasnd', 4, false, ''),
        (3, 'asldka12389sdkasnd', 4, true, ''),
        (4, 'asldka12367sdkasnd', 3, true, ''),
        (1, 'asldka12367sdkasnd', 2, true, ''),
        (2, 'asldka12367sdkasnd', 1, true, ''),
        (4, 'asldka12387sdkasnd', 2, true, ''),
        (2, 'asldka12387sdkasnd', 3, true, ''),
        (6, 'asldkan21ansdkasnd', 1, true, ''),
        (6, 'asldka12312sdkasnd', 1, false, '');