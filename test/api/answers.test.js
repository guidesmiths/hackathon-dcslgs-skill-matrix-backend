  ...
  describe('POST /api/v1/answers', () => {
    ...
    it('refactor', () => request
      ...
      .then(({ body }) => {
        ...
        expect(ecosystems[0].skills[0].id).toEqual(2);
        expect(ecosystems[0].skills[0].name).toEqual('Next.js');
        expect(ecosystems[0].skills[0].level).toEqual(2);
        ...
        expect(ecosystems[0].skills[2].id).toEqual(1);
        expect(ecosystems[0].skills[2].name).toEqual('React');
        expect(ecosystems[0].skills[2].level).toEqual(4);
